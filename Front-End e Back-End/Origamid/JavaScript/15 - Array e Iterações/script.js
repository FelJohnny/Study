...
console.log("Verifique se Baixo faz parte da lista de instrumentos e retorne true");

const instrumentos = ['Guitarra', 'Baixo', 'Bateria', 'Teclado']
console.log(instrumentos);

const validaInstrumento = instrumentos.some((item)=> item === "Baixo");

console.log(validaInstrumento);
...
console.log("Retorne uma lista com os números maiores que 100");
...
//-------------------------------------------------------------------------------------------//
console.log(" Retorne o valor total das compras")
